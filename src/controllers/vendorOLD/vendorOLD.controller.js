...
vendorController.updatePassword = async (req, res, next) => {
  try {
    // Get user input
...
vendorController.passwordValidity = async (req, res, next) => {
  try {
    // Get user input
    const { email, password } = req.body;
...
// Register
vendorController.register = async (req, res, next) => {
...
vendorController.logout = (req, res, next) => {
  try {
...
vendorController.getUserInfo = (req, res, next) => {
  try {
